...
|-------------------| ------------------- | ------------------- |---------------------------------------| -------------------------------- | --------------- |
| **Authorization** | 2 600               | лёгкая (Go Gin)     | 2 600 / 5 000 ≈ **1 CPU**             | 1 × 50 ≈ **50 MB**               | ≈ 50 Mbit/s     |
| **User**          | 1 100               | средняя (Go CRUD)   | 1 100 / 1 000 ≈ **2 CPU**             | 2 × 100 ≈ **200 MB**             | 20 Mbit/s       |
| **Calendar**      | 14 468              | лёгкая              | 14 468 / 5 000 ≈ **3 CPU**            | 3 × 50 ≈ **150 MB**              | 300 Mbit/s      |
| **Event**         | 20 258              | тяжёлая (Go-stream) | 20 258 / 300 ≈ **68 CPU**             | 68 × 200 ≈ **13,6 GB**           | 500 Mbit/s      |
| **Invitation**    | 11 576              | средняя             | 11 576 / 1 000 ≈ **12 CPU**           | 12 × 100 ≈ **1,2 GB**            | 200 Mbit/s      |
| **Reminder**      | 5 788               | средняя             | 5 788 / 1 000 ≈ **6 CPU**             | 6 × 100 ≈ **600 MB**             | 100 Mbit/s      |
| **Sync**          | 2 000               | средняя             | 2 000 / 1 000 ≈ **2 CPU**             | 2 × 100 ≈ **200 MB**             | 50 Mbit/s       |
| **Email / SMTP**  | 2 000               | лёгкая              | 2 000 / 5 000 ≈ **1 CPU**             | 1 × 50 ≈ **50 MB**               | 50 Mbit/s       |
| **API Gateway**   | 52 090              | маршрутизация       | 52 090 / 5 000 ≈ **11 CPU**           | 11 × 50 ≈ **550 MB**             | 1 Gbit/s        |
| **Nginx**         | 52 090              | reverse-proxy       | 52 090 / 5 000 ≈ **11 CPU**           | 11 × 10 ≈ **110 MB**             | 1 Gbit/s        |

| Стек (runtime)        | RPS / 1 vCPU | RAM / 1 vCPU |
|-----------------------| ------------ |--------------|
| Go (Gin, multiplexer) | **5 000**    | **50 MB**    |
| Go (обычный CRUD)     | **1 000**    | **100 MB**   |
| Go (stream / heavy)   | **300**      | **200 MB**   |
| Nginx                 | **5 000**    | **10 MB**    |
...
| Сервисный блок             | Конфигурация сервера                            | CPU  | RAM   | NVMe SSD  | HDD       | Нод/DC | Всего | Цена/ноду | Итого/мес |
|----------------------------|-------------------------------------------------|------|-------|-----------|-----------|--------|-------|-----------|-----------|
| **Kubernetes Worker**      | 2U AMD EPYC 7313P 64c, 128GB RAM, 4×4TB NVMe    | 64   | 128GB | 16TB      | -         | 18     | 144   | €1,500    | €216,000  |
| **Cassandra Hot Tier**     | 4U 2×AMD EPYC 7B13 128c, 1TB RAM, 24×8TB NVMe   | 256  | 1TB   | 192TB     | -         | 24     | 192   | €3,800    | €729,600  |
| **Cassandra Cold Tier**    | 4U 2×AMD EPYC 7313P 64c, 512GB RAM, 60×16TB HDD | 128  | 512GB | -         | 960TB     | 15     | 120   | €2,800    | €336,000  |
| **Kafka Broker**           | 2U AMD EPYC 7313P 32c, 256GB RAM, 8×2TB NVMe    | 32   | 256GB | 16TB      | -         | 6      | 48    | €1,200    | €57,600   |
| **ElasticSearch Node**     | 2U AMD EPYC 7313P 32c, 512GB RAM, 6×4TB NVMe    | 32   | 512GB | 24TB      | -         | 4      | 32    | €1,800    | €57,600   |

**Итого:** 536 нод, **€1,396,800/мес**
