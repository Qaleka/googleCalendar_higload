...
- Она задаёт только репликационные возможности для каждого региона: если в DC созданы партиции, Cassandra будет хранить 3 копии внутри этого DC(фактическое распределение будет на уровне backend).
