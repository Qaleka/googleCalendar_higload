...
| User                       | Calendar            | Event                      | Session          | Guests_calendars  | Guests_events  | Reminder       |
|----------------------------|---------------------|----------------------------|------------------|-------------------|----------------| -------------- |
...
| ------------------ | -------------------- |--------------|-------------------| ---------------- |------------------|-----------------------|-------------------|
| Вес записи         | 784 B                | 1240 B       | 1214 B            | 32 B             | 24 B             | 24 B                  | 32 B              |
| Количество записей | 500 млн (MAU)        | 25 * 500 млн | 365 * 3 * 500 млн | 125 млн (DAU)    | 25 * 500 млн * 2 | 365 * 3 * 500 млн * 2 | 365 * 2 * 500 млн |
| Общий размер       | 365 Gb               | 14,096 Tb    | 61,74 Tb          | 3,72 Gb          | 558,79 Gb        | 23,9 Tb               | 10,62 Tb          |
